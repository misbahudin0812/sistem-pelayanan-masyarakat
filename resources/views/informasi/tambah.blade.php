<x-admin-layout>
    <h1 class="text-3xl font-bold uppercase ml-6 text-center">Tambah Data</h1>
    <div class="container mx-5 bg-base-100 p-4 rounded mt-2" style="width: 78vw">
        <form method="POST" action="{{ route('tambah.informasi') }}" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-2 gap-x-3 items-top">
                <div class="w-full">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="berita" class="textarea textarea-bordered mt-1 w-full" id="berita" rows="3" required></textarea>
